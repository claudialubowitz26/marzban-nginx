...
wget -O geoip.dat https://github.com/malikshi/v2ray-rules-dat/releases/download/${latest}/GeoIP.dat
wget -O geosite.dat https://github.com/malikshi/v2ray-rules-dat/releases/download/${latest}/GeoSite.dat
cd

# Mengecek apakah unduhan berhasil
if [ $? -eq 0 ]; then
    profile
    echo "Berhasil Update GeoIP dan GeoSite"
else
    echo "Gagal Update GeoIP dan GeoSite"
fi